...
// function copyContractToClient(contractName) {
...
//         contractName + ".json"
//     );
//     //console.log(__dirname, contractPath, clientPath);
//     const contract = JSON.parse(fs.readFileSync(contractPath));
//     fs.writeFileSync(clientPath, JSON.stringify(contract, null, 2));
// }

// copyContractToClient("Utils");
// copyContractToClient("Ballot");
// copyContractToClient("Operators");
