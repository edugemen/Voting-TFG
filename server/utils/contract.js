...
function deployContracts() {
    ...
    sendTransaction(myOperators).then((opReceipt) => {
        ...
        sendTransaction(myVoteFaucet).then((vfReceipt) => {
            console.log("VoteFaucet deployed at: " + vfReceipt.contractAddress);
            setAddressInContractJson("VoteFaucet", vfReceipt.contractAddress);
            ...
            sendTransaction(myUtils).then((uReceipt) => {
                console.log("Utils deployed at: " + uReceipt.contractAddress);
